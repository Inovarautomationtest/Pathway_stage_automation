...
Then Rise a Partial Cancelation Request with first Market User 1716
...
Then check the "Approved" status a  Partial Cancelation Request with first RPM User 1716
...
Then check the "Approved" status a Partial Cancelation Request with first NOC User 1716
...
Then Request send to FCC of Partial cancelation process with  First Legal User 1716
...
Then Rise a Partial Cancelation Request with second Market User 1715
...
Then check the "Rejected" status a Partial Cancelation Request with second RPM User 1715
...
Then Rise a Partial Cancelation Request with Third Market User 1714
...
Then check the "Approved" status a Partial Cancelation Request with Third RPM User 1714
...
Then check the "Rejected" status a Partial Cancelation Request with Third NOC User 1714
...
Then Rise a Partial Cancelation Request with fourth Market User 1713
...
Then check the "Approved" status a Partial Cancelation Request with fourth RPM User 1713
...
Then check the "Approved" status a  Partial Cancelation Request with fourth NOC User 1713
...
Then partial cancelation Request reject with  fourth Legal User 1713
...
Then Rise a Partial Cancelation Request with  fifth RPM User 1719
...
Then check the "Approved" status a Partial Cancelation Request with  fifth NOC User 1719
...
Then Request send to FCC of Partial Cancelation Request with  fifth Legal User 1719
...
Then Rise a Partial Cancelation Request with  sixth RPM User 1718
...
Then check the "Rejcted" status a Partial Cancelation Request with  sixth NOC User 1718
...
Then Rise a Partial Cancelation Request with  Seventh RPM User 1717
...
Then check the "Approved" status a Partial Cancelation Request with  seventh NOC User 1717
