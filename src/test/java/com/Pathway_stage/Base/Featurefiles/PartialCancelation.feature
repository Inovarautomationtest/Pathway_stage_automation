...
Then Rise a Partial Cancelation Request with first Market User 1697
...
Then check the "Approved" status a  Partial Cancelation Request with first RPM User 1697
...
Then check the "Approved" status a Partial Cancelation Request with first NOC User 1697
...
Then Request send to FCC of Partial cancelation process with  First Legal User 1697
Then Partial Cancelation application send to FCC from the under review page with First Legal user 1697
...
Then Rise a Partial Cancelation Request with second Market User 1698
...
Then check the "Rejected" status a Partial Cancelation Request with second RPM User 1698
...
Then Rise a Partial Cancelation Request with Third Market User 1699
...
Then check the "Approved" status a Partial Cancelation Request with Third RPM User 1699
...
Then check the "Rejected" status a Partial Cancelation Request with Third NOC User 1699
...
Then Rise a Partial Cancelation Request with fourth Market User 1700
...
Then check the "Approved" status a Partial Cancelation Request with fourth RPM User 1700
...
Then check the "Approved" status a  Partial Cancelation Request with fourth NOC User 1700
...
Then partial cancelation Request reject with  fourth Legal User 1700
...
Then Rise a Partial Cancelation Request with  fifth RPM User 1701
...
Then check the "Approved" status a Partial Cancelation Request with  fifth NOC User 1701
...
Then Request send to FCC of Partial Cancelation Request with  fifth Legal User 1701
Then Partial cancelation Application send to FCC from The under review page with Legal user 1701
...
Then Rise a Partial Cancelation Request with  sixth RPM User 1702
...
Then check the "Rejcted" status a Partial Cancelation Request with  sixth NOC User 1702
...
Then Rise a Partial Cancelation Request with  Seventh RPM User 1703
...
Then check the "Approved" status a Partial Cancelation Request with  seventh NOC User 1703
...
Then partial cancelation Request reject with  seventh Legal User 1700
...
Then Rise a Partial Cancelation Request with eigth Market User 1697
...
Then check the "Approved" status a  Partial Cancelation Request with eigth RPM User 1697
...
Then check the "Approved" status a Partial Cancelation Request with eigth NOC User 1697
...
Then Request send to FCC of Partial cancelation process with  eigth Legal User 1697
Then application rejected from the Under review page for Partial cancelation with eigth legal user 1697
...
Then Rise a Partial Cancelation Request with  ninth RPM User 1701
...
Then check the "Approved" status a Partial Cancelation Request with  ninth NOC User 1701
...
Then Request send to FCC of Partial Cancelation Request with  ninth Legal User 1701
Then Partial cancelation Application reject from The under review page with ninth Legal user 1701
