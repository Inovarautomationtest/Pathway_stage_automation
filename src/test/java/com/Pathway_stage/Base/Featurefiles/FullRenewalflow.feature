...
Then Rise a Renewal Request with  first RPM User 1679
...
Then check the "Approved" status a Renewal Request with  first NOC User 1679
...
Then Request send to FCC of Renewal Request with  first Legal User 1679
Then reewalapplication sendtoFCC from underreviewpage with First legal user 1679 
...
Then Rise a Renewal Request with  second RPM User 1680
...
Then check the "Rejected" status a Renewal Request with  second NOC User 1680
...
Then Rise a Renewal Request with  third RPM User 1681
...
Then check the "Approved" status a Renewal Request with  third NOC User 1681
...
Then Full Renewal Request reject with  third Legal User 1681
...
Then Rise a Renewal Request with  fourth RPM User 1681
...
Then check the "Approved" status a Renewal Request with  fourth NOC User 1679
...
Then Request send to FCC of Renewal Request with  fourth Legal User 1679
Then reewalapplication reject from underreviewpage with fourth legal user 1679 
