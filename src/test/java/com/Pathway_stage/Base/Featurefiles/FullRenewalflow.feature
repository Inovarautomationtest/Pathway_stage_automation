...
Then Rise a Renewal Request with  first RPM User 1744
...
Then check the "Approved" status a Renewal Request with  first NOC User 1744
...
Then Request send to FCC of Renewal Request with  first Legal User 1744
...
Then Rise a Renewal Request with  second RPM User 1743
...
Then check the "Rejected" status a Renewal Request with  second NOC User 1743
...
Then Rise a Renewal Request with  third RPM User 1746
...
Then check the "Approved" status a Renewal Request with  third NOC User 1746
...
Then Full Renewal Request reject with  third Legal User 1746
