...
Then Rise a BuildOutflow Request with  First Market User 1650 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with First RPM User 1650
...
Then check the "Approved" status a BuildOutflow Request with  First NOC User 1650
...
Then Request send to FCC of BuildOutflow Request with  First Legal User 1650
Then application send to FCC from the under review page with First Legal User 1650
...
Then Rise a BuildOutflow Request with secondMarket User 1647 with "06-18-2020"
...
Then check the "Rejeted" status a BuildOutflow Request with Second RPM User 1647
...
Then Rise a BuildOutflow Request with  Third Market User 1639 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with Third RPM User 1639
...
Then check the "Rejected" status a BuildOutflow Request with  Third NOC User 1639
...
Then Rise a BuildOutflow Request with  fourth Market User 1640 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with fourth RPM User 1640
...
Then check the "Approved" status a BuildOutflow Request with  fourth NOC User 1640
...
Then BuildOutflow Request reject with  fourth Legal User 1640
...
Then Rise a BuildOutflow Request with  fifth RPM User 1641 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with  fifth NOC User 1641
...
Then Request send to FCC of BuildOutflow Request with  fifth Legal User 1641
Then buildout application send to FCC from the underreview page with fifth Legal user 1641
...
Then Rise a BuildOutflow Request with  sixth RPM User 1642 with "06-18-2020"
...
Then check the "Rejcted" status a BuildOutflow Request with  sixth NOC User 1642
...
Then Rise a BuildOutflow Request with  Seventh RPM User 1643 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with  seventh NOC User 1643
...
Then BuildOutflow Request reject with  seventh Legal User 1643
...
Then Rise a BuildOutflow Request with  eighth Market User 1644 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with eighth RPM User 1644
...
Then check the "Approved" status a BuildOutflow Request with  eighth NOC User 1644
...
Then Request send to FCC of BuildOutflow Request with  eighth Legal User 1644
Then reject Under review application with eighth Legal user 1644
...
Then Rise a BuildOutflow Request with  ninth RPM User 1645 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with  ninth NOC User 1645
...
Then Request send to FCC of BuildOutflow Request with  ninth Legal User 1645
Then reject Under review application with ninth Legal user 1645
