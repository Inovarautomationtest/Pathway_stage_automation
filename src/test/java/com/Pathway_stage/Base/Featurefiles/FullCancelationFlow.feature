...
Then Rise a full Cancelation Request with first Market User 1712
...
Then check the "Approved" status a Cancelation Request with first RPM User 1712
...
Then check the "Approved" status a Cancelation Request with first NOC User 1712
...
Then Request send to FCC of full cancelation process with  First Legal User 1712
...
Then Rise a Cancelation Request with second Market User 1711
...
Then check the "Rejected" status a Cancelation Request with second RPM User 1711
...
Then Rise a Cancelation Request with Third Market User 1710
...
Then check the "Approved" status a Cancelation Request with Third RPM User 1710
...
Then check the "Rejected" status a Cancelation Request with Third NOC User 1710
...
Then Rise a Cancelation Request with fourth Market User 1709
...
Then check the "Approved" status a Cancelation Request with fourth RPM User 1709
...
Then check the "Approved" status a Cancelation Request with fourth NOC User 1709
...
Then Full cancelation Request reject with  fourth Legal User 1709
...
Then Rise a full Cancelation Request with  fifth RPM User 1708
...
Then check the "Approved" status a full Cancelation Request with  fifth NOC User 1708
...
Then Request send to FCC of full Cancelation Request with  fifth Legal User 1708
...
Then Rise a full Cancelation Request with  sixth RPM User 1707
...
Then check the "Rejcted" status a full Cancelation Request with  sixth NOC User 1707
...
Then Rise a full Cancelation Request with  Seventh RPM User 1706
...
Then check the "Approved" status a full Cancelation Request with  seventh NOC User 1706
