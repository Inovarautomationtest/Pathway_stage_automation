...
public class Buildoutflowpages extends Basepage
{
	...
	private By proceedbuttonforRPM = By.xpath(".//*[@class='btn-grid approve create-cancel float-right ng-star-inserted']");
	...
	private By sendtofccbuildoutbutton =By.xpath("(.//*[@class='btn-grid approve ng-star-inserted'])[1]");
