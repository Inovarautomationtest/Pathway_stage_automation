...
public class Cancelationflowpages extends Basepage {
	...
	private By createNewcancelationbutton = By.xpath(".//*[@class='btn-grid approve create-cancel ml-0 mr-0 button-margin ng-star-inserted']");
	...
	private By selectreasondropdown = By.xpath("(.//*[@class='ng-untouched ng-pristine ng-valid'])[2]");
	...
	private By approvebutton = By.xpath("(.//*[@class='btn-grid approve ng-star-inserted'])[1]");
	private By rejectbutton = By.xpath("(.//*[@class='btn-grid reject ng-star-inserted'])[1]");
	...
	public void approvecancelationwithRPMuser() {
		...
		try {
			...
			sleep();
			elementclickbyjs(rpmconfirmationforapprovedbutton);
			sleep();
			/*Screen screen = new Screen();
			Thread.sleep(3000);
			screen.click("E:\\WORKSPACE\\Pathway_stage1\\Pathway_Stage\\Pathway_stage\\Screenshot (469).png");*/
